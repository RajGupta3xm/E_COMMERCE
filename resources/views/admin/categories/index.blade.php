            ...
            <div class="md:flex md:items-center md:justify-between mb-6">
                ...
                <div class="mt-4 flex md:mt-0 md:ml-4">
                    <a href="{{ route('admin.categories.import') }}"
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div class="w-full sm:w-64">
                            <div class="relative">
                             ...
                             <input type="search" id="categorySearch" placeholder="Search categories..." class="block w-full sm:w-64 pl-10 pr-3 py-2 border rounded-md">
                            </div>
                        </div>
                            ...
                            <div class="px-4 py-4 sm:px-6 hover:bg-gray-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        @else
                                            <div
                                                class="flex-shrink-0 h-12 w-12 mr-4 bg-gray-100 rounded-lg flex items-center justify-center">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center">
                                                <p class="text-sm font-medium text-blue-600 truncate category-name">
                                            ...
                                            <div class="mt-1 flex items-center text-sm text-gray-500">
                                                ...
                                                <svg class="flex-shrink-0 mx-1 h-4 w-4 text-gray-400" fill="currentColor"
                                                    viewBox="0 0 20 20">
