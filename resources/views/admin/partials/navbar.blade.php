            ...
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center ml-4 lg:ml-0">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3">
                        <div class="bg-gradient-to-br from-primary-600 to-purple-600 w-8 h-8 rounded-lg flex items-center justify-center">
                        ...
                        <span class="px-2 py-1 text-xs bg-primary-100 text-primary-800 rounded-full">Admin</span>
                    </a>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" 
                        ...
                        <div class="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-purple-500 flex items-center justify-center text-white font-semibold">
